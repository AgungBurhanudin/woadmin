    ...
    <div id="addPria">
        <div class="col-md-6" style="float: left">
            ...
            <div class="form-group">
                ...
                <input name="nama_lengkap_pria" id="nama_lengkap_pria" type="text" required="required" class="form-control required" placeholder="" />
            </div>
            <div class="form-group">
...
<!--
                <select class="form-control required" name="agama_pria" id="agama_pria">
    ...
    <button onclick="moveStep('step-2', 'step-3', 'addPria')" class="btn btn-primary nextBtn pull-right" type="button">Next</button>
</div>