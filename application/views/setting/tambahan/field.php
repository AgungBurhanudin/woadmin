                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-align-justify"></i> Data Field Paket Acara <?= $tambahan_tipe->nama_tambahan_paket ?>
                        </div>
                        <div class="card-body">
                            <table class="table">
                                <tr>
...
//                        $("#table_body").append(table);
    ...
    function editField(id) {
        $.ajax({
            url: "<?= base_url() ?>Setting/Tambahan/getField",
            type: "GET",
            data: "id=" + id,
            dataType: "JSON",
            success: function (data) {
...
//        $(e).parent().parent().remove();
    ...
    function saveUrutan(id) {
        ...
        $.ajax({
            url: "<?= base_url() ?>Setting/Tambahan/saveUrutan",
            type: "POST",
